...
extension Color {
    ...
    static let lightCoral = Color(red: 240 / 255.0, green: 128 / 255.0, blue: 128 / 255.0)
    static let darkSalmon = Color(red: 233 / 255.0, green: 150 / 255.0, blue: 122 / 255.0)
    static let salmon = Color(red: 250 / 255.0, green: 128 / 255.0, blue: 114 / 255.0)
    ...
    static let paleGoldenRod = Color(red: 238 / 255.0, green: 232 / 255.0, blue: 170 / 255.0)
    ...
    static let lawnGreen = Color(red: 124 / 255.0, green: 252 / 255.0, blue: 0 / 255.0)
    ...
    static let lightGreen = Color(red: 144 / 255.0, green: 238 / 255.0, blue: 144 / 255.0)
    static let paleGreen = Color(red: 152 / 255.0, green: 251 / 255.0, blue: 152 / 255.0)
    static let darkSeaGreen = Color(red: 143 / 255.0, green: 188 / 255.0, blue: 143 / 255.0)
    static let mediumSpringGreen = Color(red: 0 / 255.0, green: 250 / 255.0, blue: 154 / 255.0)
    static let springGreen = Color(red: 0 / 255.0, green: 255 / 255.0, blue: 127 / 255.0)
    static let seaGreen = Color(red: 46 / 255.0, green: 139 / 255.0, blue: 87 / 255.0)
    static let mediumAquaMarine = Color(red: 102 / 255.0, green: 205 / 255.0, blue: 170 / 255.0)
    ...
    static let mediumTurquoise = Color(red: 72 / 255.0, green: 209 / 255.0, blue: 204 / 255.0)
    static let paleTurquoise = Color(red: 175 / 255.0, green: 238 / 255.0, blue: 238 / 255.0)
    static let aquaMarine = Color(red: 127 / 255.0, green: 255 / 255.0, blue: 212 / 255.0)
    static let powderBlue = Color(red: 176 / 255.0, green: 224 / 255.0, blue: 230 / 255.0)
    static let cadetBlue = Color(red: 95 / 255.0, green: 158 / 255.0, blue: 160 / 255.0)
    static let steelBlue = Color(red: 70 / 255.0, green: 130 / 255.0, blue: 180 / 255.0)
    static let cornFlowerBlue = Color(red: 100 / 255.0, green: 149 / 255.0, blue: 237 / 255.0)
    static let deepSkyBlue = Color(red: 0 / 255.0, green: 191 / 255.0, blue: 255 / 255.0)
    static let dodgerBlue = Color(red: 30 / 255.0, green: 144 / 255.0, blue: 255 / 255.0)
    static let lightBlue = Color(red: 173 / 255.0, green: 216 / 255.0, blue: 230 / 255.0)
    static let skyBlue = Color(red: 135 / 255.0, green: 206 / 255.0, blue: 235 / 255.0)
    static let lightSkyBlue = Color(red: 135 / 255.0, green: 206 / 255.0, blue: 250 / 255.0)
    static let midnightBlue = Color(red: 25 / 255.0, green: 25 / 255.0, blue: 112 / 255.0)
    ...
    static let mediumPurple = Color(red: 147 / 255.0, green: 112 / 255.0, blue: 219 / 255.0)
    static let darkMagenta = Color(red: 139 / 255.0, green: 0 / 255.0, blue: 139 / 255.0)
    ...
    static let magenta = Color(red: 255 / 255.0, green: 0 / 255.0, blue: 255 / 255.0)
    static let orchid = Color(red: 218 / 255.0, green: 112 / 255.0, blue: 214 / 255.0)
    static let mediumVioletRed = Color(red: 199 / 255.0, green: 21 / 255.0, blue: 133 / 255.0)
    static let paleVioletRed = Color(red: 219 / 255.0, green: 112 / 255.0, blue: 147 / 255.0)
    ...
    static let blanchedAlmond = Color(red: 255 / 255.0, green: 235 / 255.0, blue: 205 / 255.0)
    static let wheat = Color(red: 245 / 255.0, green: 222 / 255.0, blue: 179 / 255.0)
    static let cornSilk = Color(red: 255 / 255.0, green: 248 / 255.0, blue: 220 / 255.0)
    static let lemonChiffon = Color(red: 255 / 255.0, green: 250 / 255.0, blue: 205 / 255.0)
    static let lightGoldenRodYellow = Color(red: 250 / 255.0, green: 250 / 255.0, blue: 210 / 255.0)
    static let lightYellow = Color(red: 255 / 255.0, green: 255 / 255.0, blue: 224 / 255.0)
    static let saddleBrown = Color(red: 139 / 255.0, green: 69 / 255.0, blue: 19 / 255.0)
    static let sienna = Color(red: 160 / 255.0, green: 82 / 255.0, blue: 45 / 255.0)
    static let chocolate = Color(red: 210 / 255.0, green: 105 / 255.0, blue: 30 / 255.0)
    static let peru = Color(red: 205 / 255.0, green: 133 / 255.0, blue: 63 / 255.0)
    static let sandyBrown = Color(red: 244 / 255.0, green: 164 / 255.0, blue: 96 / 255.0)
    static let burlyWood = Color(red: 222 / 255.0, green: 184 / 255.0, blue: 135 / 255.0)
    static let tan = Color(red: 210 / 255.0, green: 180 / 255.0, blue: 140 / 255.0)
    static let rosyBrown = Color(red: 188 / 255.0, green: 143 / 255.0, blue: 143 / 255.0)
    static let moccasin = Color(red: 255 / 255.0, green: 228 / 255.0, blue: 181 / 255.0)
    static let navajoWhite = Color(red: 255 / 255.0, green: 222 / 255.0, blue: 173 / 255.0)
    static let peachPuff = Color(red: 255 / 255.0, green: 218 / 255.0, blue: 185 / 255.0)
    static let mistyRose = Color(red: 255 / 255.0, green: 228 / 255.0, blue: 225 / 255.0)
    static let lavenderBlush = Color(red: 255 / 255.0, green: 240 / 255.0, blue: 245 / 255.0)
    static let linen = Color(red: 250 / 255.0, green: 240 / 255.0, blue: 230 / 255.0)
    static let oldLace = Color(red: 253 / 255.0, green: 245 / 255.0, blue: 230 / 255.0)
    static let papayaWhip = Color(red: 255 / 255.0, green: 239 / 255.0, blue: 213 / 255.0)
    static let seaShell = Color(red: 255 / 255.0, green: 245 / 255.0, blue: 238 / 255.0)
    static let mintCream = Color(red: 245 / 255.0, green: 255 / 255.0, blue: 250 / 255.0)
    static let slateGray = Color(red: 112 / 255.0, green: 128 / 255.0, blue: 144 / 255.0)
    static let lightSlateGray = Color(red: 119 / 255.0, green: 136 / 255.0, blue: 153 / 255.0)
    static let lightSteelBlue = Color(red: 176 / 255.0, green: 196 / 255.0, blue: 222 / 255.0)
    static let lavender = Color(red: 230 / 255.0, green: 230 / 255.0, blue: 250 / 255.0)
    static let floralWhite = Color(red: 255 / 255.0, green: 250 / 255.0, blue: 240 / 255.0)
    static let aliceBlue = Color(red: 240 / 255.0, green: 248 / 255.0, blue: 255 / 255.0)
    static let ghostWhite = Color(red: 248 / 255.0, green: 248 / 255.0, blue: 255 / 255.0)
    static let honeydew = Color(red: 240 / 255.0, green: 255 / 255.0, blue: 240 / 255.0)
